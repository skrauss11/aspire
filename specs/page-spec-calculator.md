...
- **Effect on Aspire Rate computation:** the priced goal is the cost target. Aspire Rate is the priced goal's **primary inflation vector** — for Home it's the housing CAGR at the user's geography; for Family it's CPI; for Freedom it's equity-linked. The basket-component weights (50/25/15/10 etc.) remain visible in Block C's bar chart as the inflation context, but they no longer compute the Aspire Rate. The priced goal's vector does. _Per the 2026-05-16 deviation-canonized review of PR #28 — see `_DRIFT_REPORT_2026-05-11.md` §11. The blended-basket framing was a V2-era stand-in for not knowing what the user was actually pricing; the goal-vector framing is canon going forward._
