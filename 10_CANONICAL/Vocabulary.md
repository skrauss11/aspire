...
- **Aspire Rate** — the required money-growth rate to cover the priced future at the user's current assumptions. Equivalent to the 5-yr trailing CAGR of the **priced goal's primary inflation vector** (housing for Home, CPI for Family-child, equity-linked for Freedom). On the Calculator (single priced goal) it is that one goal's vector. On the Simulator (multi-goal) it is the dollar-weighted CAGR across priced goals' vectors. The *floor* — what you need to break even. _Per the 2026-05-16 deviation-canonized review of PR #28; supersedes the prior "5-yr trailing CAGR of the goals basket" framing — see `_DRIFT_REPORT_2026-05-11.md` §11 Conflict 21 sub-resolution._
